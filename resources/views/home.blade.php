                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="trackable">
                                        <div class="css-tab-content">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 content-text">
                                                    <h3>Просто свяжитесь с нами любым удобным для вас способом</h3>

                                                    <p>Это можно сделать, позвонив нашим менеджерам по телефонам, указанным на любой странице сайта. Мы вас выслушаем, предоставим подробную консультацию и дадим полезную рекомендацию совершенно бесплатно. Также есть возможность заказать бесплатный звонок в нижеприведенной форме, и мы сами вам перезвоним, экономя ваши деньги. Перейдя на страницу с контактной информацией, вы можете отправить письмо по электронной почте, прикрепив любые файлы при наличии такой необходимости.</p>
                                                </div><!-- /.col-md-6 -->
                                            </div><!-- /.row -->
                                        </div><!-- /.css-tab-content -->
                                    </div>
                                    <div role="tabpanel" class="tab-pane fade" id="fast">
                                        <div class="css-tab-content">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 content-text">
                                                    <h3>После уточнения всех вопросов, мы приступаем к своей работе.</h3>

                                                    <p>Наш курьер встречается с вами, независимо от того, где вы находитесь - в Москве или в Беларуси. Он уточняет все детали, составляет с вами договор, принимает оплату (если необходимо оплатить покупки в Москве) и организовывает доставку посылки по нужному адресу. Оплата может производится как наличным, так и безналичным платежом.</p>
                                                </div><!-- /.col-md-6 -->
                                            </div><!-- /.row -->
                                        </div><!-- /.css-tab-content -->
                                    </div>
                                    <div role="tabpanel" class="tab-pane fade" id="reliable">
                                        <div class="css-tab-content">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 content-text">
                                                    <h3>Вы получаете посылку в оговоренном в договоре месте.</h3>

                                                    <p>На сегодняшний день, доставка посылок из Москвы или в Москву по базовым тарифам действует для следующих городов Беларуси: Минск, Жодино, Борисов, Толочин, Орша, Могилев, Горки, Витебск. В остальные города и районы РБ стоимость доставки посылок оговаривается отдельно, в зависимости от удаленности. География наших услуг постоянно расширяется и новые города, для доставки по базовым тарифам, будут постоянно добавляться.

                                                        Также базовые тарифы действуют и для доставки в Беларусь покупок из следующих магазинов и интернет-магазинов Москвы: ZARA, H&M, Adidas, Nike, Reebok, Спортмастер, O’STIN, BAON, ECCO, Levi's, Zara HOME, Carlo Pazolini, Cacharel, Bershka, Cropp, Lacoste, KANZLER, PANDORA, Valtera, U.S. Polo Assn., Детский мир, Mothercare, Reserved, Л'Этуаль, LEGO, Massimo Dutti, eBay, Aliexpress. Причем, мы можем даже не только забрать, но и оплатить вашу покупку в указанных магазинах. Мы также, проверим, выкупим и привезем любой товар с Авито. Также мы готовы оплатить и принять посылки из любых зарубежных интернет-магазинов по всему миру.</p>
                                                </div><!-- /.col-md-6 -->
                                            </div><!-- /.row -->
                                        </div><!-- /.css-tab-content -->
                                    </div>
...
<noscript><div><img src="https://mc.yandex.ru/watch/61162459" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
